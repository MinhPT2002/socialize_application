...
class OtpTextField extends StatefulWidget {
  OtpTextField({
    ...
    this.focusedBorderColor = const Color(0xFF3184F2),
...
class _OtpTextFieldState extends State<OtpTextField> {
  ...
  Widget _buildTextField({
    ...
    final double width = (Get.width - 40 - ((widget.numberOfFields) * 10)) /
        widget.numberOfFields;
    return Container(
      width: width,
      height: width,
      ...
      child: TextField(
        ...
        cursorColor: widget.cursorColor ?? appThemes.mainColor,
